...
class Agent(object):
    ...
    def update_dest(self):
        ...
        if 1156.3/2 + buffer < self.pos[0] < 2042.1/2 + 885.8/2 + buffer and buffer < self.pos[1] < 751.1/2 + 297/2 + buffer: #facilty room
            self.dest = np.array([1156.3/2 + buffer, 751.1/2 + buffer - 241.8/2 + 100/2])
        elif buffer < self.pos[0] < 1156.3/2 + buffer and 751.1/2 + buffer - 241.8/2 < self.pos[1] < 751.1/2 + buffer - 241.8/2 + 200/2: #fire exit corridor
            self.dest = np.array([buffer + 100/2 + 50/2, 751.1/2 + buffer - 241.8/2 - 20/2])
            ...
            self.dest = np.array([735/2 + buffer and 751.1/2 + buffer + 10, 751.1/2 + buffer + 150/2 + 2*885.8/2  +200/2])
        ...
        elif 1156.3 / 2 + buffer + 3*(284/2)< self.pos[0] <1156.3 / 2 + buffer + 3*(284/2) + 937.3/2and 751.1/2 + (3 * 885.8/2) + 321.6/2 + buffer < self.pos[1] < 751.1/2 + (3 * 885.8/2) + 321.6/2 + 734/2 + buffer: #room 208
            self.dest = np.array([1156.3/2 + 324/2 + buffer + 150/2 + 892/2 -350/2, 751.1/2 + (3 * 885.8/2) + 321.6/2 + buffer])

        elif 1156.3 / 2 + buffer + 3*(284/2) + 937.3/2 < self.pos[0] < 1156.3 / 2 + buffer + 3*(284/2) + 937.3/2 + 1189.2/4 and 751.1/2 + (3 * 885.8/2) + 321.6/2 + buffer < self.pos[1] < 751.1/2 + (3 * 885.8/2) + 321.6/2 + 734/2 + buffer: #room 208
            self.dest = np.array([1156.3 / 2 + buffer + 3*(284/2) + 937.3/2 + 200/2, 751.1/2 + (3 * 885.8/2) + 321.6/2 + buffer])
        elif 1156.3 / 2 + buffer + 3*(284/2) + 937.3/2 + 1189.2/4 < self.pos[0] < 1156.3 / 2 + buffer + 3*(284/2) + 937.3/2 + 1189.2/2 and 751.1/2 + (3 * 885.8/2) + 321.6/2 + buffer < self.pos[1] < 751.1/2 + (3 * 885.8/2) + 321.6/2 + 734/2 + buffer: #room 208
            self.dest = np.array([1156.3 / 2 + buffer + 3*(284/2) + 937.3/2 + 1189.2/2 - 200/2, 751.1/2 + (3 * 885.8/2) + 321.6/2 + buffer])

        elif 1156.3 / 2 + buffer + 3*(284/2) + 937.3/2 + 1189.2/2 < self.pos[0] < 1156.3/2 + 324/2 + (2*892)/2 + (2*884/2) + 327/2 + buffer - 884/4 and 751.1/2 + (3 * 885.8/2) + 321.6/2 + buffer < self.pos[1] < 751.1/2 + (3 * 885.8/2) + 321.6/2 + 734/2 + buffer: #room 208
            self.dest = np.array([1156.3 / 2 + buffer + 3*(284/2) + 937.3/2 + 1189.2/2 + 200/2, 751.1/2 + (3 * 885.8/2) + 321.6/2 + buffer])
        elif 1156.3/2 + 324/2 + (2*892)/2 + (2*884/2) + 327/2 + buffer - 884/4 < self.pos[0] < 1156.3/2 + 324/2 + (2*892)/2 + (2*884/2) + 327/2 + buffer and 751.1/2 + (3 * 885.8/2) + 321.6/2 + buffer < self.pos[1] < 751.1/2 + (3 * 885.8/2) + 321.6/2 + 734/2 + buffer: #room 208
            self.dest = np.array([1156.3/2 + 324/2 + (2*892)/2 + (2*884/2) + 327/2 + buffer - 200/2, 751.1/2 + (3 * 885.8/2) + 321.6/2 + buffer])
