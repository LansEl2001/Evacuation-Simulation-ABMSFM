...
walls = [ [1156.3/2 + buffer, buffer, 2042.1/2 + buffer, buffer], #A214
          [1156.3/2 + buffer, buffer, 1156.3/2 + buffer, 751.1/2 + buffer - 241.8/2],
          [1156.3/2 + buffer, 751.1/2 + buffer, 1156.3/2 + buffer, 751.1/2 + 297/2 + buffer],
          ...
          [buffer, 751.1/2 + buffer - 241.8/2, buffer + 100/2, 751.1/2 + buffer - 241.8/2],
          [buffer+200/2, 751.1/2 + buffer - 241.8/2, 735/2 + 421.3/2 + buffer, 751.1/2 + buffer - 241.8/2],
          [buffer+200/2, buffer, buffer+200/2, 751.1/2 + buffer - 241.8/2],


          [buffer, 751.1/2 + buffer, 735/2 + buffer, 751.1/2 + buffer], #210, 209, 208
          [buffer, buffer, buffer, 751.1/2 + (3*885.8)/2 + buffer],

          [735/2 + buffer, 751.1/2 + buffer, 735/2 + buffer, 751.1/2 + 100/2 + buffer],
          [735/2 + buffer, 751.1/2 + 100/2 + buffer, 735/2 + buffer, 751.1/2 + 100/2 + 100/2 + 485.8/2 + buffer],
          [735/2 + buffer, 751.1/2 + 100/2 + 100/2 + 485.8/2 + 100/2 + buffer, 735/2 + buffer, 751.1/2 + 100/2 + 100/2 + 485.8/2 + 100/2 + 200/2 + buffer],
          [735/2 + buffer, 751.1/2 + 100/2 + 100/2 + 100/2 + 485.8/2 + 100/2 + 200/2 + 100/2 + buffer, 735/2 + buffer, 751.1/2 + 885.8/2 + 855.6/2 + buffer],
          ...
          [735/2 + buffer, 751.1/2 + 885.8/2 + 855.6/2 + buffer, 735/2 + buffer, 751.1/2 + 885.8/2 + 855.6/2 + buffer + 332.8/2],
          ...
          [735/2 + buffer, 751.1/2 + 885.8/2 + 855.6/2 + buffer + 332.8/2 + 100/2, 735/2 + buffer, 751.1/2 + 100/2 + 100/2 + 485.8/2 + 100/2 + 200/2 + 100/2 + 485.8/2 + 100/2 + 200/2 + 100/2 + 485.8/2 + 100/2 + 100/2 + 321.6/2 + buffer],

          [buffer, 751.1/2 + 885.8/2 + buffer, 735/2 + buffer, 751.1/2 + 885.8/2 + buffer],
          [buffer, 751.1/2 + 885.8/2 + 855.6/2 + buffer, 735/2 + buffer, 751.1/2 + 885.8/2 + 855.6/2 + buffer],
          ...
          [1156.3 / 2 + buffer + 284/2, 751.1 / 2 + (3 * 885.8) / 2 + 321.6 / 2 + buffer, 1156.3 / 2 + buffer + 284/2, 751.1 / 2 + (3 * 885.8) / 2 + 321.6 / 2 + 734 / 2 + buffer],
          [1156.3 / 2 + buffer + 2*(284/2), 751.1 / 2 + (3 * 885.8) / 2 + 321.6 / 2 + buffer, 1156.3 / 2 + buffer + 2*(284/2), 751.1 / 2 + (3 * 885.8) / 2 + 321.6 / 2 + 734 / 2 + buffer],
          [1156.3 / 2 + buffer + 3*(284/2), 751.1 / 2 + (3 * 885.8) / 2 + 321.6 / 2 + buffer, 1156.3 / 2 + buffer + 3*(284/2), 751.1 / 2 + (3 * 885.8) / 2 + 321.6 / 2 + 734 / 2 + buffer],
          [1156.3 / 2 + buffer + 3*(284/2) + 937.3/2, 751.1 / 2 + (3 * 885.8) / 2 + 321.6 / 2 + buffer, 1156.3 / 2 + buffer + 3*(284/2) + 937.3/2, 751.1 / 2 + (3 * 885.8) / 2 + 321.6 / 2 + 734 / 2 + buffer],
          [1156.3 / 2 + buffer + 3*(284/2) + 937.3/2 + 1189.2/2, 751.1 / 2 + (3 * 885.8) / 2 + 321.6 / 2 + buffer, 1156.3 / 2 + buffer + 3*(284/2) + 937.3/2 + 1189.2/2, 751.1 / 2 + (3 * 885.8) / 2 + 321.6 / 2 + 734 / 2 + buffer],
          ...
          [1156.3/2 + buffer, 751.1/2 + (3*885.8)/2 + 321.6/2 + buffer, 1156.3/2 + buffer + 3*(284/2) + 100/2, 751.1/2 + (3*885.8)/2 + 321.6/2 + buffer],
          [1156.3/2 + buffer, 751.1/2 + (3*885.8)/2 + 321.6/2 + buffer, 1156.3/2 + buffer + 3*(284/2) + 100/2, 751.1/2 + (3*885.8)/2 + 321.6/2 + buffer],
          [1156.3/2 + buffer + 3*(284/2) + 100/2 + 100/2, 751.1/2 + (3*885.8)/2 + 321.6/2 + buffer, 1156.3/2 + buffer + 3*(284/2) + 937.3/2 + 100/2, 751.1/2 + (3*885.8)/2 + 321.6/2 + buffer],
          [1156.3/2 + buffer + 3*(284/2) + 937.3/2 + 3*(100/2), 751.1/2 + (3*885.8)/2 + 321.6/2 + buffer, 1156.3/2 + buffer + 3*(284/2) + 937.3/2 + 3*(100/2) + 589.2/2, 751.1/2 + (3*885.8)/2 + 321.6/2 + buffer],
          [1156.3/2 + buffer + 3*(284/2) + 937.3/2 + 3*(100/2) + 589.2/2 + 200/2, 751.1/2 + (3*885.8)/2 + 321.6/2 + buffer, 1156.3/2 + buffer + 3*(284/2) + 937.3/2 + 3*(100/2) + 589.2/2 + 400/2, 751.1/2 + (3*885.8)/2 + 321.6/2 + buffer],
          [1156.3/2 + buffer + 3*(284/2) + 937.3/2 + 3*(100/2) + 589.2/2 + 600/2, 751.1/2 + (3*885.8)/2 + 321.6/2 + buffer, 1156.3/2 + 324/2 + (2*892)/2 + (2*884/2) + 327/2 + buffer - 200/2 - 200/2, 751.1/2 + (3*885.8)/2 + 321.6/2 + buffer],
          [1156.3/2 + 324/2 + (2*892)/2 + (2*884/2) + 327/2 + buffer - 200/2, 751.1/2 + (3*885.8)/2 + 321.6/2 + buffer, 1156.3/2 + 324/2 + (2*892)/2 + (2*884/2) + 327/2 + buffer, 751.1/2 + (3*885.8)/2 + 321.6/2 + buffer],
          #[1156.3/2 + buffer + 3*(284/2) + 937.3/2 + 3*(100/2) + 589.2/2 + 800/2 + 584/2, 751.1/2 + (3*885.8)/2 + 321.6/2 + buffer, 1156.3/2 + buffer + 3*(284/2) + 937.3/2 + 3*(100/2) + 589.2/2 + 900/2 + 584/2, 751.1/2 + (3*885.8)/2 + 321.6/2 + buffer],
...
for j in range(0, nr_experiments):
    ...
    for i in range(0, nr_agents):  # For all objects
        ...
        while found == False:
            ...
            if agents_found < int(nr_agents / 7):
                object_x = np.random.uniform(1156.3/2 + buffer, 2042.1/2 + 885.8/2 + buffer)
                object_y = np.random.uniform(buffer, 751.1/2 + 297/2 + buffer)
            elif agents_found < int(2 * nr_agents / 7):
                object_x = np.random.uniform(buffer, 735/2 + buffer)
                object_y = np.random.uniform(751.1/2 + buffer, 751.1/2 + 885.8/2 + buffer)
            elif agents_found < int(3 * (nr_agents / 7)):
                object_x = np.random.uniform(buffer, 735/2 + buffer)
                object_y = np.random.uniform(751.1/2 + 885.8/2 + buffer, 751.1/2 + 885.8/2 + 855.6/2 + buffer)
            elif agents_found < int(4 * (nr_agents / 7)):
                object_x = np.random.uniform(buffer, 735/2 + buffer)
                object_y = np.random.uniform(751.1/2 + 885.8/2 + 855.6/2 + buffer, 751.1/2 + (3*885.8)/2 + buffer)
            elif agents_found < int(5 * (nr_agents / 7)):
                object_x = np.random.uniform(1156.3 / 2 + buffer + 3*(284/2), 1156.3 / 2 + buffer + 3*(284/2) + 937.3/2)
                object_y = np.random.uniform(751.1/2 + (3 * 885.8/2) + 321.6/2 + buffer, 751.1/2 + (3 * 885.8/2) + 321.6/2 + 734/2 + buffer)
            elif agents_found < int(6 * (nr_agents / 7)):
                object_x = np.random.uniform(1156.3 / 2 + buffer + 3*(284/2) + 937.3/2, 1156.3 / 2 + buffer + 3*(284/2) + 937.3/2 + 1189.2/2)
                object_y = np.random.uniform(751.1/2 + (3 * 885.8/2) + 321.6/2 + buffer, 751.1/2 + (3 * 885.8/2) + 321.6/2 + 734/2 + buffer)
            else:
                object_x = np.random.uniform(1156.3 / 2 + buffer + 3*(284/2) + 937.3/2 + 1189.2/2, 1156.3/2 + 324/2 + (2*892)/2 + (2*884/2) + 327/2 + buffer)
                object_y = np.random.uniform(751.1/2 + (3 * 885.8/2) + 321.6/2 + buffer, 751.1/2 + (3 * 885.8/2) + 321.6/2 + 734/2 + buffer)
