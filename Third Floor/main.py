...
def main():
    ...
    while run:
        ...
        for agent_i in agents:
            ...
            if (start_position[0] >= 1156.3/2 + 4203/2 + buffer + world_offset[0]) or (start_position[1] >= 751.1/2 + (3 * 885.8/2) + 321.6/2 + buffer + world_offset[1] and start_position[0] <= buffer + 735/2 + 324/2 + world_offset[0]) or (start_position[1] < 751.1/2 + buffer - 241.8/2 + world_offset[1] and start_position[0] < buffer +200/2 + world_offset[0]):
