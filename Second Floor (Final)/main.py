...
rooms = {
    ...
    "a210": {
        ...
        "topright": (735/2 + 3*buffer/2, 751.1/2 + (1*885.8)/2 + 3*buffer/2)
    },
    "a209": {
        "bottomleft": (3*buffer/2, 751.1/2 + (1*885.8)/2 + 3*buffer/2),
        "topright": (735/2 + 3*buffer/2, 751.1/2 + (2*885.8)/2 + 3*buffer/2)
    },
    "a208": {
        "bottomleft": (3*buffer/2, 751.1/2 + (2*885.8)/2 + 3*buffer/2),
        "topright": (735/2 + 3*buffer/2, 751.1/2 + (3*885.8)/2 + 3*buffer/2)
    },
    "a205": {
        "bottomleft": (1032.1 / 2 + 324 / 2 + 3*buffer/2, 751.1 / 2 + (3 * 885.8) / 2 + 321.6 / 2 + 3*buffer/2),
        "topright": (1032.1 / 2 + 324 / 2 + 892 / 2 + 3*buffer/2, 751.1 / 2 + (3 * 885.8) / 2 + 321.6 / 2 + 734 / 2 + 3*buffer/2)
    },
    "a204": {
        "bottomleft": (1032.1 / 2 + 324 / 2 + 892 / 2 + 3*buffer/2, 751.1 / 2 + (3 * 885.8) / 2 + 321.6 / 2 + 3*buffer/2),
        "topright": (1032.1 / 2 + 324 / 2 + (2 * 892) / 2 + 3*buffer/2, 751.1 / 2 + (3 * 885.8) / 2 + 321.6 / 2 + 734 / 2 + 3*buffer/2)
    },
    "a203": {
        "bottomleft": (1032.1 / 2 + 324 / 2 + (2 * 892) / 2 + 3*buffer/2, 751.1 / 2 + (3 * 885.8) / 2 + 321.6 / 2 + buffer),
        "topright": (1032.1 / 2 + 324 / 2 + (2 * 892) / 2 + 884 / 2 + 3*buffer/2, 751.1 / 2 + (3 * 885.8) / 2 + 321.6 / 2 + 734 / 2 + 3*buffer/2)
    },
    "a202": {
        "bottomleft": (1032.1 / 2 + 324 / 2 + (2 * 892) / 2 + 884 / 2 + 3*buffer/2, 751.1 / 2 + (3 * 885.8) / 2 + 321.6 / 2 + 3*buffer/2),
        "topright": (1032.1 / 2 + 324 / 2 + (2 * 892) / 2 + (2 * 884) / 2 + 3*buffer/2, 751.1 / 2 + (3 * 885.8) / 2 + 321.6 / 2 + 734 / 2 + 3*buffer/2)
    }
}
...
#rooms = {
#    "a214": {
#        "bottomleft": (1032.1 / 2 + buffer, buffer),
#        "topright": (1917.9 / 2 + buffer, 751.1/2 + buffer)
#    },
#    "a215": {
#        "bottomleft": (1032.1 / 2 + 885.8 / 2 + buffer, buffer),
#        "topright": (1917.9 / 2 + 885.8 / 2 + buffer, 751.1 / 2 + buffer)
#    },
#    "a210": {
#        "bottomleft": (buffer, 751.1/2 + buffer),
#        "topright": (735/2 + buffer, 751.1/2 + (1*885.8)/2 + buffer)
#    },
#    "a209": {
#        "bottomleft": (buffer, 751.1/2 + (1*885.8)/2 + buffer),
#        "topright": (735/2 + buffer, 751.1/2 + (2*885.8)/2 + buffer)
#    },
#    "a208": {
#        "bottomleft": (buffer, 751.1/2 + (2*885.8)/2 + buffer),
#        "topright": (735/2 + buffer, 751.1/2 + (3*885.8)/2 + buffer)
#    },
#    "a205": {
#        "bottomleft": (1032.1 / 2 + 324 / 2 + buffer, 751.1 / 2 + (3 * 885.8) / 2 + 321.6 / 2 + buffer),
#        "topright": (1032.1 / 2 + 324 / 2 + 892 / 2 + buffer, 751.1 / 2 + (3 * 885.8) / 2 + 321.6 / 2 + 734 / 2 + buffer)
#    },
#    "a204": {
#        "bottomleft": (1032.1 / 2 + 324 / 2 + 892 / 2 + buffer, 751.1 / 2 + (3 * 885.8) / 2 + 321.6 / 2 + buffer),
#        "topright": (1032.1 / 2 + 324 / 2 + (2 * 892) / 2 + buffer, 751.1 / 2 + (3 * 885.8) / 2 + 321.6 / 2 + 734 / 2 + buffer)
#    },
#    "a203": {
#        "bottomleft": (1032.1 / 2 + 324 / 2 + (2 * 892) / 2 + buffer, 751.1 / 2 + (3 * 885.8) / 2 + 321.6 / 2 + buffer),
#        "topright": (1032.1 / 2 + 324 / 2 + (2 * 892) / 2 + 884 / 2 + buffer, 751.1 / 2 + (3 * 885.8) / 2 + 321.6 / 2 + 734 / 2 + buffer)
#    },
#    "a202": {
#        "bottomleft": (1032.1 / 2 + 324 / 2 + (2 * 892) / 2 + 884 / 2 + buffer, 751.1 / 2 + (3 * 885.8) / 2 + 321.6 / 2 + buffer),
#        "topright": (1032.1 / 2 + 324 / 2 + (2 * 892) / 2 + (2 * 884) / 2 + buffer, 751.1 / 2 + (3 * 885.8) / 2 + 321.6 / 2 + 734 / 2 + buffer)
#    }
#}


num_agents_per_group = 15
...
#Exit Choice Params
exits_info = [(np.array([735 / 2 + buffer, 751.1 / 2 + 3*(885.8 / 2) + 321.6 / 2 + 297/2 + 321.6/4 + buffer]), 750), #bottom left staircase
               (np.array([1032.1 / 2 + 324/2 + 892/2 + 892/2 + 884/2 + 884/2 + 327/2 + buffer, 751.1 / 2 + (3 * 885.8 / 2) + 321.6 / 4 + buffer]), 1000), #bottom right staircase
               (np.array([buffer + 150/2, 751.1 / 2 - 241.8/2 + buffer]), 1000)]  #fire exit
pmax = 1
...
def main():
    ...
    while run:
        ...
        for agent_i in agents:
            ...
            if ((100/2 + buffer + world_offset[0] <= start_position[0] <= 200/2 + buffer + world_offset[0] and start_position[1] <= 751.1 / 2 + buffer - 241.8 / 2 + world_offset[1]) or (
                    start_position[0] <= 735/2 + buffer + world_offset[0] and start_position[1] >= 751.1 / 2 + (3 * 885.8) / 2 + 321.6 / 2 + 297/2 + 321.6/4 + buffer + world_offset[1]) or (
                    start_position[0] >= 1032.1 / 2 + 324/2 + 892/2 + 892/2 + 884/2 + 884/2 + 327/2 + buffer + world_offset[0])) and agent_i.Goal == 0:
                agent_i.Goal = 1
            ...
            if (100/2 + buffer + world_offset[0] <= start_position[0] <= 200/2 + buffer + world_offset[0] and start_position[1] <= 751.1 / 2 + buffer - 241.8 / 2 + world_offset[1]) or (
                    start_position[0] <= 735/2 + buffer + world_offset[0] and start_position[1] >= 751.1 / 2 + (3 * 885.8) / 2 + 321.6 / 2 + 297/2 + 321.6/4 + buffer + world_offset[1]) or (
                    start_position[0] >= 1032.1 / 2 + 324/2 + 892/2 + 892/2 + 884/2 + 884/2 + 327/2 + buffer + world_offset[0]):
